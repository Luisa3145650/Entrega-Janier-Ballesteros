...
class ISampleGrabber(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetCurrentBuffer(self, pBufferSize: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class IMediaSample(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetTime(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        ...
        def GetMediaTime(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class IPin(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def QueryInternalConnections(self, nPin: hints.Incomplete) -> tuple['IPin', hints.Incomplete]: ...
...
class IPropertySetter(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def PrintXML(self, cbXML: hints.Incomplete, indent: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        ...
        def GetProps(self) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        ...
        def SaveToBlob(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        ...
        def PrintXMLW(self, cchXML: hints.Incomplete, indent: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class IEnumMediaTypes(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def Next(self, cMediaTypes: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class IEnumFilters(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def Next(self, cFilters: hints.Incomplete) -> tuple['IBaseFilter', hints.Incomplete]: ...
...
class IAMTimelineComp(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetRecursiveLayerOfTypeI(self, pWhichLayer: hints.Incomplete, Type: hints.Incomplete) -> tuple['IAMTimelineObj', hints.Incomplete]: ...
...
class IEnumPins(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def Next(self, cPins: hints.Incomplete) -> tuple['IPin', hints.Incomplete]: ...
...
class IResize(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def get_Size(self) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def get_InputSize(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
__all__ = [
    'AMTimelineEffect', 'IMediaDet', 'IAMTimelineObj',
    'IDxtAlphaSetter', 'IPin', 'DEXTER_VALUE', 'IAMTimelineTrans',
    'DxtKey', 'AMTimelineSrc', 'TIMELINE_MAJOR_TYPE_COMPOSITE',
    'PropertySetter', 'DxtCompositor', 'PINDIR_INPUT',
    '__MIDL___MIDL_itf_qedit_0000_0000_0002',
    '__MIDL___MIDL_itf_qedit_0000_0000_0003', 'IPropertySetter',
    'IFilterGraph', 'TIMELINE_MAJOR_TYPE_TRACK', 'NullRenderer',
    'IAMTimelineVirtualTrack', 'TIMELINE_MAJOR_TYPE_EFFECT',
    'IMediaSample', 'MediaDet', 'tagSTATSTG', 'TIMELINE_MAJOR_TYPE',
    'IGrfCache', 'ColorSource', 'SmartRenderEngine', 'State_Stopped',
    'IAMTimelineEffect', 'IRenderEngine', '_AMMediaType', 'IResize',
    'IEnumMediaTypes', 'Library', 'AMTimelineObj', 'AMTimelineGroup',
    'IStream', 'TIMELINE_MAJOR_TYPE_TRANSITION', 'IAMSetErrorLog',
    'AMTimelineComp', 'SampleGrabber', 'IXml2Dex', 'IBaseFilter',
    'State_Running', 'IRenderEngine2', 'IAMTimelineTransable',
    '_PinInfo', '_FilterInfo', 'IAMTimelineTrack', 'IAMTimeline',
    'IDxtJpeg', '_FilterState', 'TIMELINE_MAJOR_TYPE_GROUP',
    'PINDIR_OUTPUT', 'IAMTimelineGroup', 'IAMTimelineEffectable',
    'AMTimelineTrans', 'IDxtCompositor', 'ISmartRenderEngine',
    '__MIDL___MIDL_itf_qedit_0000_0000_0007', 'AMTimeline',
    'DxtAlphaSetter', 'IEnumPins', 'IGraphBuilder', 'State_Paused',
    'IAMTimelineSrc', 'LONG_PTR', 'IDXEffect', 'IReferenceClock',
    'IFindCompressorCB', 'RenderEngine', 'ISampleGrabberCB',
    'IAMTimelineSplittable', 'DEXTER_PARAM', 'IAMTimelineComp',
    'DxtJpeg', '_PinDirection', 'TIMELINE_MAJOR_TYPE_SOURCE',
    'IMediaFilter', 'Xml2Dex', 'IAMErrorLog', 'IEnumFilters',
    'IMediaLocator', 'MediaLocator', 'AudMixer', 'IDxtKey',
    'ISampleGrabber', 'IPersistStream', 'AMTimelineTrack',
    'typelib_path'
]

_check_version('1.4.16', 1776654930.954628)
