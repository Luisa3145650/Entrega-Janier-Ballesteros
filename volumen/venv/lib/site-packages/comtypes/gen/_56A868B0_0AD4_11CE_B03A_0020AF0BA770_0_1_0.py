...
class IAMStats(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IDispatch):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetValueByIndex(self, lIndex: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def GetValueByName(self, szName: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
...
class IBasicVideo(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IDispatch):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetSourcePosition(self) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        ...
        def GetDestinationPosition(self) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def SetDefaultDestinationPosition(self) -> hints.Hresult: ...
        def GetVideoSize(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def GetVideoPaletteEntries(self, StartIndex: hints.Incomplete, Entries: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def GetCurrentImage(self, pBufferSize: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class IBasicVideo2(IBasicVideo):
    ...
    if TYPE_CHECKING:  # commembers
        def GetPreferredAspectRatio(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class IMediaEvent(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IDispatch):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetEvent(self, msTimeout: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
...
class IVideoWindow(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IDispatch):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetWindowPosition(self) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def GetMinIdealImageSize(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def GetMaxIdealImageSize(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def GetRestorePosition(self) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
...
class IQueueCommand(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def InvokeAtStreamTime(self, time: hints.Incomplete, iid: hints.Incomplete, dispidMethod: hints.Incomplete, wFlags: hints.Incomplete, cArgs: hints.Incomplete, pDispParams: hints.Incomplete, pvarResult: hints.Incomplete) -> tuple['IDeferredCommand', hints.Incomplete, hints.Incomplete]: ...
        def InvokeAtPresentationTime(self, time: hints.Incomplete, iid: hints.Incomplete, dispidMethod: hints.Incomplete, wFlags: hints.Incomplete, cArgs: hints.Incomplete, pDispParams: hints.Incomplete, pvarResult: hints.Incomplete) -> tuple['IDeferredCommand', hints.Incomplete, hints.Incomplete]: ...
...
__all__ = [
    'IQueueCommand', 'IMediaTypeInfo', 'IAMCollection', 'IBasicVideo',
    'IPinInfo', 'IMediaEventEx', 'LONG_PTR', 'IVideoWindow',
    'IDeferredCommand', 'IBasicVideo2', 'IFilterInfo', 'IMediaEvent',
    'FilgraphManager', 'IRegFilterInfo', 'IBasicAudio',
    'IMediaControl', 'IMediaPosition', 'Library', 'typelib_path',
    'IAMStats'
]

_check_version('1.4.16', 1786597523.525697)
